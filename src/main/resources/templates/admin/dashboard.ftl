    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" class="form-control" id="datepicker" name="datepicker"
                                       value="21/03/1998" placeholder="Birth Date">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group form-group-default">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-group-default">
                                <label>Phone</label>
                                <input type="text" class="form-control" value="+99361616161" name="phone"
                                       placeholder="Phone">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" class="form-control"
                                       value="st Kemine Ashgabat Turkmenistan" name="address"
                                       placeholder="Address">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3 mb-1">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <textarea class="form-control" name="about" placeholder="About Me" rows="3">
                                    A man who hates loneliness ;)
                                </textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="card card-profile card-secondary">
                <div class="card-header"
                     style="background-image: url('/static/admin/karaoke/img/blogpost.jpg')">
                    <div class="profile-picture">
                        <div class="avatar avatar-xl">
                            <img src="/static/admin/karaoke/img/profile.svg" alt="..."
                ...
                <div class="card-body">
                    <div class="user-profile text-center">
                        <div class="name">${user.fullName}, 19</div>
