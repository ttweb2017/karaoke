...
create table video (id bigint not null, active bit not null, name varchar(255), image varchar(255), video varchar(255), singer_id bigint, primary key (id)) engine=MyISAM default charset=UTF8;
